...
function TagAX1(id, width, height)
{
  ...
  o+='<table width="600" height="400" bordercolor="#FF9900" style="margin-top:50px; margin-left:0px;" border="1">';
  o+='<tr>';
  o+='<td height="23" bgcolor="#006699"><font color="#FFFFFF">MRU状态</font></td>';
  o+='</tr>';
 
  o+='<tr><td><table align="center"  border="0" width="500" height="300">';
  o+='<tr><td width="100">';
  o+=GL("g3_status")+'</td><td width="250">';
  if(g_is3GNet)
  	o+=GL("use_3gnet");
  else
  	o+=GL("unuse_3gnet");
  o+='</td></tr>';
  o+='<tr><td width="100">';
  o+=GL("video_status")+'</td><td width="250">';
  if(g_isVideo)
  	o+=GL("use_video");
  else
  	o+=GL("unuse_video");
  o+='</td></tr>';
  o+='<tr><td width="100">';
  o+=GL("alarm_staus")+'</td><td width="250">';
  if(g_isAlarm)
  	o+=GL("use_alarm");
  else
  	o+=GL("unuse_alarm");
  o+='</td></tr>';
  o+='<tr><td width="100">';
  o+=GL("sd_status")+'</td><td width="250">'+GL("result");
  o+='</td></tr>';
  o+='<tr><td width="100">';
  o+=GL("battery_status")+'</td><td width="250">'+GL("result");
  o+='';
  o+='</td></tr>';
//  o+='<tr><td>';
//  o+=GL("version_status")+'</td><td width="250">'+GL("result");
//  o+='</td></tr>';
